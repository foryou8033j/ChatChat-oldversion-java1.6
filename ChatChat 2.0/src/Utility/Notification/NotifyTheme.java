...
public class NotifyTheme {
    ...
    static{
        ...
        for(int i=0;i<defaultIconSet.length;i++){
            ...
            defaultIconSet[i] = new ImageIcon(DesktopNotify.class.getClassLoader().getResource((i+1)+".png")).getImage();
            		//return (URL)getClass().getClassLoader().getResource("bullets.jpg"); //재즈피아노*
        }
        Dark = new DarkTheme();
    ...
    public static class DarkTheme extends NotifyTheme {
        public DarkTheme() {
            titleFont = new Font("맑은 고딕",Font.BOLD,14);
            contentFont = new Font("맑은 고딕",Font.PLAIN,12);
